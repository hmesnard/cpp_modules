...
Form::Form() : name(""), _signed(false), gradeToSign(150), gradeToExec(150)
{
}
...
Form::Form(std::string const & name, int const & gradeToSign, int const & gradeToExec) : name(name), _signed(false), gradeToSign(gradeToSign), gradeToExec(gradeToExec)
{
